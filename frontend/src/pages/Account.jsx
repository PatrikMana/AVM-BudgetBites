...
const Account = () => {
    ...
    const user = {
        email: email,
        username: username,
        plan: "free", // You can store this in cookies too
        ...
        >
            <main className="px-4 py-8 md:py-12">
                <div className="max-w-3xl mx-auto space-y-6">
                    {/* Profile Header */}
                    <div className="rounded-2xl border border-white/10 bg-zinc-900/80 p-6 backdrop-blur">
                        <div className="flex items-start justify-between">
                            <div className="flex items-center gap-4">
                                <div className="h-20 w-20 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                                    <span className="text-emerald-400 text-3xl font-semibold">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-zinc-900/80 p-6 backdrop-blur">
                        ...
                        {user.plan === "free" ? (
                            <>
                                <div className="rounded-xl bg-emerald-500/5 border border-emerald-500/20 p-4 space-y-3 mb-4">
                                ...
                                <button className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-900/30 transition hover:bg-emerald-500">
                            ...
                            <div className="rounded-xl bg-emerald-500/5 border border-emerald-500/20 p-4">
                                ...
                                <button className="w-full rounded-xl border border-white/10 bg-zinc-800/60 px-5 py-3 text-sm font-semibold text-white transition hover:bg-zinc-800/90">
                                    Manage Subscription
                                </button>
                            </div>
                        )}
