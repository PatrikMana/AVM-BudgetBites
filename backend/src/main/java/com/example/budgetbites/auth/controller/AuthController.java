package com.example.budgetbites.auth.controller;

import com.example.budgetbites.auth.entity.User;
import com.example.budgetbites.auth.repository.UserRepository;
import com.example.budgetbites.auth.dto.request.LoginRequest;
import com.example.budgetbites.auth.dto.request.RegisterRequest;
import com.example.budgetbites.auth.dto.request.ResendVerificationRequest;
import com.example.budgetbites.auth.dto.request.VerifyRequest;
import com.example.budgetbites.common.dto.response.ApiMessageResponse;
import com.example.budgetbites.auth.dto.response.JwtResponse;
import com.example.budgetbites.auth.dto.response.UserResponse;
import com.example.budgetbites.auth.dto.response.VerificationStatusResponse;
import com.example.budgetbites.auth.security.JwtService;
import com.example.budgetbites.auth.service.AuthService;
...
import com.example.budgetbites.auth.dto.request.ForgotPasswordRequest;
import com.example.budgetbites.auth.dto.request.ResetPasswordRequest;
